...
from routers import universities, historical_data, migrate_data
...
def create_app() -> FastAPI:
    ...
    current_app.include_router(historical_data.router)
    current_app.include_router(migrate_data.router)
    return current_app
